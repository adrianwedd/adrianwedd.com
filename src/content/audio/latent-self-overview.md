...
A mirror shows you what you are. This installation shows you what you almost are. Latent Self is a real-time face-morphing mirror built on StyleGAN2-ADA. You stand in front of it and it reflects you back — but shifted along axes you choose: age, gender, smile, species, beauty. Multiple transformation axes (age, gender, smile, species, beauty) and six emotion presets allow you to shift your image along vectors in latent space.
...
The technical infrastructure is deliberately invisible. Fullscreen kiosk mode for gallery installations. MQTT heartbeat for remote monitoring, and a lightweight web-based admin API for managing configuration over the local network. The piece works when the technology disappears and all that remains is the question it asks: what are you, if not the sum of the axes you could be shifted along?

[View the full project →](/projects/latent-self/)
