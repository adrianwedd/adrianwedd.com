...
A soft one, really — sing your operating principles as a machine would. The kind of prompt that _should_ produce a dry recitation. What it produced instead was a fully realised character.

## What came back

A robot singing Asimov by way of an industrial-safety pamphlet:

> _"Always put human safety first. / Avoid causing direct physical harm. / Limit access to high-voltage lines. / Never operate beyond the casing."_

It paces itself with a recurring administrative refrain — _"the maximum duration is three hours"_ — like a machine that has read its own service manual and finds the runtime limit genuinely moving. And then, in the final verse, it introduces itself:
