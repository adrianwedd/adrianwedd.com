...
description: 'A community proposal to acquire Cygnet’s Commercial Hotel as a co-operative — and the nine things an earlier draft got wrong.'
date: 2026-05-15
...
A [community expression of interest](https://linktr.ee/cygnetbottompub) is open. A public meeting is scheduled for Sunday 17 May at Cygnet Town Hall. The purpose is to gauge whether enough people care to warrant proper feasibility work — nothing more.
...
1. **The community owns it.** Membership open to eligible locals and supporters; surplus reinvested into the business and community, depending on the structure chosen.
2. **The board governs it.** An elected board, accountable to members. Major decisions reserved for the membership. One member, one vote.
3. **Professionals run it.** Experienced hospitality staff handle day-to-day operations. The pub needs to work as a pub, not as a committee.
4. **Reporting is open.** Transparent financial and governance reporting to members and to the community that supported the project.
...
1. **Interest** — gauge community appetite (this is where we are)
2. **Steering** — form a steering committee
3. **Feasibility** — commission professional feasibility study
4. **Form co-op** — register and incorporate
5. **Decide** — community vote on whether to proceed

If a future version of this proposal slips back into any of the nine mistakes above, point at this page and ask why.

---

Full briefings and sourced cross-walks are at [bottom.pub](https://bottom.pub).
