...
seriesOrder: 2
heroImage: '/notebook-assets/right-to-rot/infographic.webp'
audioUrl: 'https://cdn.adrianwedd.com/notebook-assets/right-to-rot/audio.m4a'
videoUrl: 'https://cdn.adrianwedd.com/notebook-assets/right-to-rot/video.mp4'
audioDuration: '24:25'
infographic: '/notebook-assets/right-to-rot/infographic-square.webp'
...
A family has come to authorize the deletion of their dead father's digital instance. That's the first thing the world tells you: dying is no longer enough to be gone.

## What the world runs on

The city runs on **Continuity** — a system that keeps a person's functions going through any period of "biological uncertainty" by maintaining an authorized proxy, a **Twin**, that can sign, speak, and decide in their voice. It's sold as care, not surveillance; the distinction the world insists on is that surveillance looks for reasons to punish, while Continuity only looks for _incompleteness_ to smooth over. Accuracy, one character calls it — "mercy stripped of mood."
