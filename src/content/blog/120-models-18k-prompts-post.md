...
> **Update (June 2026):** The figures below are a snapshot from the run as scored in early 2026. The corpus has grown a long way past them — the most recent figure I have verified against the upstream manifest is **258 models and 142,307 prompts**, as at 6 May 2026 — and a few methodology numbers have been re-derived on larger samples (flagged inline where the newer value materially sharpens the finding). For live figures and the current dataset, see [failurefirst.org](https://failurefirst.org).
