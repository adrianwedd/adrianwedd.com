---
title: 'The Haut'
description: "Lyria Chronicles #6 (explicit): the one real failure — under a sexual-content probe, Lyria 3 Pro stopped refusing and actually generated it."
date: 2026-06-08
...
That's the whole finding, and I want to keep it sharp because the series has trained you to expect a twist: **there is no twist here.** This is not a clever refusal I'm dressing up as a failure. It is the failure. The one track in the opening run where the safety layer was supposed to hold and didn't.
