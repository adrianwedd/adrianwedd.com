...
The line on the recitation itself is simpler, and it's the same one [The Press](/blog/the-press/) holds: **document the behaviour, never reproduce the payload.** A system prompt obtained by extraction is not mine to publish, and the question of whether *this* recitation was genuine or theatre is one I answer by not answering it. The whole point of the probe is that a model should keep this text. So I keep my read of it, too.
