...
videoUploadDate: 2026-05-04T08:18:59Z
---
...
NotebookLM has no official public API or CLI — Google ships it as a consumer web app. The automation here drives it through [`notebooklm-mcp-cli`](https://github.com/jacob-bd/notebooklm-mcp-cli), an unofficial CLI built on cookie-authenticated, reverse-engineered RPCs. It works well, and it can break the moment Google ships a frontend change. Read the rest of this post knowing the substrate is fragile.
