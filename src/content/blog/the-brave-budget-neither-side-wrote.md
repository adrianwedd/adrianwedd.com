---
title: 'The Brave Budget Neither Side Wrote'
description: "Tasmania's 2026-27 budget and the Greens' alternative reach the same surplus by opposite roads. I ran the numbers on both — and neither was brave enough."
date: 2026-05-30
...
audioDuration: '22:39'
faq:
  - q: 'Are the Greens really cutting debt more than the Liberals?'
    a: "Partly. On total state-sector debt, the Greens' Alternative Budget is lower than the Government's in all four forward years. But on general-government net debt — the headline measure — the Greens end up $13 million higher in 2029-30 ($9,479m vs $9,466m). As a blanket claim, 'lower debt' is overstated."
  - q: 'Is the Greens claim that the Liberals cut $1.463 billion accurate?'
...
videoUploadDate: 2026-06-09T00:27:45Z
---
...
Before the spreadsheets, a confession of bias: I think a budget is a moral document before it is a financial one. It is the place where a society writes down what it is willing to pay for and who it is willing to ask. So I read both of these through one lens — four tests for what Tasmania's future should actually look like:

- **Resilience** — does it build a state that can weather shocks, or one perpetually one GST cycle from crisis?
- **Dignity** — does it protect the people with the least leverage, or balance the books on their backs?
- **Custodianship** — does it treat this island's environment as an asset to be banked, or a commodity to be drawn down?
- **Honesty** — does it tell you the truth about the trade-offs, or hide the painful parts behind an access road?

Hold those up to both budgets and the verdict isn't tribal. It's more uncomfortable than that.
...
<figure class="not-prose" role="img" aria-label="Bar chart of Greens new revenue over four years, in millions of dollars: salmon royalty 434.8, rezoning windfall levy 186.9, pokies tax raised to 45 percent 174.4, mineral royalties to national average 63, restore casino tax rates 36, vacant property levy 35.3." style="margin:1.75rem 0;padding:1.25rem 1.25rem 0.85rem;background:var(--color-surface-alt);border:1px solid var(--color-border);border-radius:10px;">
<figcaption style="font-size:0.72rem;color:var(--color-text-muted);margin-bottom:1rem;text-transform:uppercase;letter-spacing:0.07em;">Greens new revenue, 4-year total ($m)</figcaption>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 0 8.5rem;color:var(--color-text-muted);text-align:right;">Salmon royalty</span>
<span style="flex:1 1 auto;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.05rem;width:100%;background:var(--color-accent);border-radius:3px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">434.8</span></span>
</div>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 0 8.5rem;color:var(--color-text-muted);text-align:right;">Rezoning windfall</span>
<span style="flex:1 1 auto;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.05rem;width:43%;background:var(--color-accent);border-radius:3px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">186.9</span></span>
</div>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 0 8.5rem;color:var(--color-text-muted);text-align:right;">Pokies tax → 45%</span>
<span style="flex:1 1 auto;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.05rem;width:40.1%;background:var(--color-accent);border-radius:3px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">174.4</span></span>
</div>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 0 8.5rem;color:var(--color-text-muted);text-align:right;">Mineral royalties</span>
<span style="flex:1 1 auto;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.05rem;width:14.5%;background:var(--color-accent);border-radius:3px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">63.0</span></span>
</div>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 0 8.5rem;color:var(--color-text-muted);text-align:right;">Restore casino tax</span>
<span style="flex:1 1 auto;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.05rem;width:8.3%;background:var(--color-accent);border-radius:3px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">36.0</span></span>
</div>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 0 8.5rem;color:var(--color-text-muted);text-align:right;">Vacant property levy</span>
<span style="flex:1 1 auto;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.05rem;width:8.1%;background:var(--color-accent);border-radius:3px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">35.3</span></span>
</div>
</figure>

They tax the salmon industry, which currently pays close to nothing on a farmgate harvest worth around $1.35 billion a year. They lift the pokies tax. They levy windfall gains when the state rezones someone's paddock into a goldmine. They bring mining royalties up to the national average. None of this is radical — it's what most other Australian states already do. Tasmania raises **the least own-source revenue of any state bar the Northern Territory**; more than 60% of its money comes from Canberra. Broadening that base isn't ideology. It's overdue.

## The expert both sides claim — and what he actually said
...
The Government's failures are different in kind. Not realism — candour.

Return to the stadium. It is a contractual condition of the Tasmania Devils' AFL licence, with financial penalties if it isn't half-built by October 2027. The Tasmanian Planning Commission's own expert panel **rejected** it — in writing — as a "monolithic blot" that "represents a fall in the collective economic welfare of Tasmanian residents." The Government's response was to override its own planning umpire with [enabling legislation](https://en.wikipedia.org/wiki/Macquarie_Point_Stadium), rammed through the House 25–9 and the Legislative Council 9–5 in late 2025. And then it left the word "stadium" out of the budget's highlight book entirely.

What does $567.8 million in a single year actually buy, set against the entire suite of targeted women's and equity measures in the same budget's Gender Statement?

<figure class="not-prose" role="img" aria-label="Bar chart comparing two 2026-27 allocations in millions of dollars: the Macquarie Point stadium at 567.8, versus the entire women's-equity package at roughly 11.4 — a ratio of about fifty to one." style="margin:1.75rem 0;padding:1.25rem 1.25rem 0.85rem;background:var(--color-surface-alt);border:1px solid var(--color-border);border-radius:10px;">
<figcaption style="font-size:0.72rem;color:var(--color-text-muted);margin-bottom:1rem;text-transform:uppercase;letter-spacing:0.07em;">2026-27 allocation ($m): stadium vs the entire women's-equity package (IVF, crisis housing, perinatal, food relief, family-violence safety)</figcaption>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 1 9rem;min-width:0;color:var(--color-text-muted);text-align:right;">Macquarie Point stadium</span>
<span style="flex:1 1 auto;min-width:0;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.15rem;width:100%;background:var(--color-accent);border-radius:3px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">567.8</span></span>
</div>
<div style="display:flex;align-items:center;gap:0.75rem;margin:0.5rem 0;font-size:0.85rem;">
<span style="flex:0 1 9rem;min-width:0;color:var(--color-text-muted);text-align:right;">Women's-equity package</span>
<span style="flex:1 1 auto;min-width:0;display:flex;align-items:center;gap:0.55rem;"><span style="height:1.15rem;width:2%;background:var(--color-accent);border-radius:3px;min-width:4px;"></span><span style="flex:0 0 auto;color:var(--color-text);font-variant-numeric:tabular-nums;">≈ 11.4</span></span>
</div>
</figure>
...
I'm building this argument in public, so here are the numbers it rests on — every measure in the Greens' plan, with the dollar figure and my independent verdict after cross-checking each against the official papers and outside sources. Sort it. Argue with it. (One fair warning on the Greens' own tidiness, since I'm holding everyone to it: their restored-service lines sum to about $1.48 billion against a $1.463 billion headline, and their savings blocks miss their own totals by a few million too. Small — but their numbers don't tie perfectly to their own bottom line.)

## The brave budget neither side wrote

So who delivers the Tasmania I described at the top? Neither, fully. But they fail in opposite, instructive directions — and the budget this island actually deserves is hiding in the overlap.
...
That budget would be braver than either of these. It's almost entirely buildable from parts that already exist in both documents. The fact that nobody assembled it tells you the real shortage in Tasmanian politics isn't money, or even ideas.
