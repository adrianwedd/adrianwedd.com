...
I built Strategic Acquisitions to automate that pipeline for Australian public and social housing organisations. It fetches listings from the Realty in AU API, generates GPT-4 analytical insights, runs ML-based property valuations, and scores each opportunity against a multi-factor strategic framework, subsequently creating Jira issues for action.
