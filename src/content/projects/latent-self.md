...
*Latent Self* is a real-time face-morphing mirror built on StyleGAN2-ADA. You stand in front of it and it reflects you back—but shifted along axes you choose: age, gender, smile, species, beauty. Six emotion presets map to directions in latent space, each one a vector away from the face you walked in with.
