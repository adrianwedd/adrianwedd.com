...
It started because I kept reaching for textures that felt familiar but didn't exist in any sample library. They existed in my own past work, but extracting them manually was slow enough to kill the creative impulse that wanted them. The engine automates the archaeology. A suite of automated tests with CI/CD and performance regression detection ensure the tool doesn't quietly degrade the thing it's supposed to preserve.
