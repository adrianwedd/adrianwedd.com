...
Read STRATEGY.md before any task in this repo — it records constraints that
aren't derivable from the code (permalink permanence, media-quality rules,
social-autopublish safety) and the reasoning behind past decisions.
